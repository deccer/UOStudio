...
namespace UOStudio.Client.Engine.Mathematics
{
    ...
    public struct OrientedBoundingBox : IEquatable<OrientedBoundingBox>, IFormattable
    {
        ...
        public Vector3[] GetCorners()
        {
            ...
            Vector3.TransformDirection(ref xv, ref Transformation, out xv);
            Vector3.TransformDirection(ref yv, ref Transformation, out yv);
            Vector3.TransformDirection(ref zv, ref Transformation, out zv);
        ...
        public ContainmentType Contains(ref Vector3 point)
        {
            ...
            Matrix.Invert(ref Transformation, out var invTrans);

            Vector3.TransformPosition(ref point, ref invTrans, out var locPoint);
        ...
        public ContainmentType Contains(Vector3[] points)
        {
            ...
            for (var i = 0; i < points.Length; i++)
            {
                Vector3.TransformPosition(ref points[i], ref invTrans, out var locPoint);
        ...
        public ContainmentType Contains(BoundingSphere sphere, bool IgnoreScale = false)
        {
            ...
            Vector3.TransformPosition(ref sphere.Center, ref invTrans, out var locCenter);
            ...
            else
            {
                ...
                Vector3.TransformDirection(ref vRadius, ref invTrans, out vRadius);
        ...
        public ContainmentType ContainsLine(ref Vector3 L1, ref Vector3 L2)
        {
            ...
            Vector3.TransformPosition(ref L1, ref invTrans, out var LB1);
            Vector3.TransformPosition(ref L1, ref invTrans, out var LB2);
        ...
        public bool Intersects(ref Ray ray, out Vector3 point)
        {
            ...
            Ray bRay;
            Vector3.TransformDirection(ref ray.Direction, ref invTrans, out bRay.Direction);
            Vector3.TransformPosition(ref ray.Position, ref invTrans, out bRay.Position);
            ...
            if (intersects)
                Vector3.TransformPosition(ref point, ref Transformation, out point);
        ...
        public static Matrix GetBoxToBoxMatrix(ref OrientedBoundingBox A, ref OrientedBoundingBox B, bool NoMatrixScaleApplied = false)
        {
            ...
            {
                Matrix.Invert(ref A.Transformation, out var AInvMat);
        ...
        public static void Merge(ref OrientedBoundingBox A, ref OrientedBoundingBox B, bool NoMatrixScaleApplied = false)
        {
            ...
            Vector3.TransformPosition(bCorners, ref AtoB_Matrix, bCorners);
            ...
            Vector3.TransformPosition(ref newCenter, ref A.Transformation, out newCenter);
