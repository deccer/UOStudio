...
namespace UOStudio.Client.Engine.Mathematics
{
    ...
    public struct Matrix3x3 : IEquatable<Matrix3x3>, IFormattable
    {
        ...
        {
            Vector3.Subtract(ref target, ref eye, out var zaxis); zaxis.Normalize();
        ...
        {
            Vector3.Subtract(ref eye, ref target, out var zaxis); zaxis.Normalize();
            Vector3.Cross(ref up, ref zaxis, out var xaxis); xaxis.Normalize();
            Vector3.Cross(ref zaxis, ref xaxis, out var yaxis);
        ...
        {
            return new Matrix(
                Value.M11, Value.M12, Value.M13, 0, Value.M21, Value.M22, Value.M23, 0,
                Value.M31, Value.M32, Value.M33, 0, 0, 0, 0, 1);
        }
        ...
        {
            return MathUtil.NearEqual(a.M11, b.M11) &&
        ...
        {
            return value is Matrix3x3 strongValue && Equals(ref strongValue);
        }
    }
}
