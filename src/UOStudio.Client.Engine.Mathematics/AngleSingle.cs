    ...
    public struct AngleSingle : IComparable, IComparable<AngleSingle>, IEquatable<AngleSingle>, IFormattable
    {
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            return format == null
                ...
                : string.Format(formatProvider, "{0}°", MathUtil.RadiansToDegrees(radians).ToString(format, CultureInfo.CurrentCulture));
        }
        ...
        {
            return obj is AngleSingle angleSingle && this == angleSingle;
        }
    }
}
