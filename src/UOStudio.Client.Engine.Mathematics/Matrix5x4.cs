...
namespace UOStudio.Client.Engine.Mathematics
{
    ...
    public struct Matrix5x4 : IEquatable<Matrix5x4>, IFormattable
    {
        ...
        /// </summary>
        public static readonly int SizeInBytes = Unsafe.SizeOf<Matrix5x4>();
        ...
        public Matrix5x4(float[] values)
        {
            ...
            if (values.Length != 20)
                throw new ArgumentOutOfRangeException(nameof(values), "There must be 20 input values for Matrix5x4.");
        ...
        public float this[int index]
        {
            get
            {
                ...
                throw new ArgumentOutOfRangeException(nameof(index), "Indices for Matrix5x4 run from 0 to 19, inclusive.");
            }
            ...
            set
            {
                switch (index)
                {
                    ...
                    default: throw new ArgumentOutOfRangeException(nameof(index), "Indices for Matrix5x4 run from 0 to 19, inclusive.");
                }
            }
        }
        ...
        public float this[int row, int column]
        {
            ...
            {
                if (row < 0 || row > 4)
                    throw new ArgumentOutOfRangeException(nameof(row), "Rows for matrices run from 0 to 4, inclusive.");
