...
namespace UOStudio.Client.Engine.Mathematics
{
    ...
    public struct Half
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref = "T:DXPlayground.Mathematics.Half" /> structure.
        /// </summary>
        /// <param name = "value">The floating point value that should be stored in 16 bit format.</param>
        public Half(float value)
        {
            this.RawValue = HalfUtils.Pack(value);
        }
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref = "T:System.Single" /> to <see cref = "T:DXPlayground.Mathematics.Half" />.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref = "T:DXPlayground.Mathematics.Half" /> to <see cref = "T:System.Single" />.
        /// </summary>
        /// <param name = "value">The value to be converted.</param>
        /// <returns>The converted value.</returns>
