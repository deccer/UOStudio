...
namespace UOStudio.Client.Engine.Mathematics
{
    ...
    public struct Vector3 : IEquatable<Vector3>, IFormattable
    {
        ...
        public static void Project(ref Vector3 vector, float x, float y, float width, float height, float minZ, float maxZ, ref Matrix worldViewProjection, out Vector3 result)
        {
            ...
            TransformPosition(ref vector, ref worldViewProjection, out v);
        ...
        public static void Unproject(ref Vector3 vector, float x, float y, float width, float height, float minZ, float maxZ, ref Matrix worldViewProjection, out Vector3 result)
        {
            ...
            TransformPosition(ref v, ref matrix, out result);
        }
        ...
        /// </remarks>
        public static void TransformPosition(ref Vector3 coordinate, ref Matrix transform, out Vector3 result)
        {
        ...
        /// with coordinates as the w component can safely be ignored.
        /// </remarks>
        public static Vector3 TransformPosition(Vector3 coordinate, Matrix transform)
        {
            TransformPosition(ref coordinate, ref transform, out var result);
            return result;
        }
        ...
        /// with coordinates as the w component can safely be ignored.
        /// </remarks>
        public static void TransformPosition(Vector3[] source, ref Matrix transform, Vector3[] destination)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
            ...
            for (var i = 0; i < source.Length; ++i)
            {
                TransformPosition(ref source[i], ref transform, out destination[i]);
            }
        }
        ...
        /// </remarks>
        public static void TransformDirection(ref Vector3 normal, ref Matrix transform, out Vector3 result)
        {
            result = new Vector3(
        ...
        /// rather than location because normal vectors should not be translated.
        /// </remarks>
        public static Vector3 TransformDirection(Vector3 normal, Matrix transform)
        {
            TransformDirection(ref normal, ref transform, out var result);
            return result;
        }
        ...
        /// rather than location because normal vectors should not be translated.
        /// </remarks>
        public static void TransformDirection(Vector3[] source, ref Matrix transform, Vector3[] destination)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
            ...
            for (var i = 0; i < source.Length; ++i)
            {
                TransformDirection(ref source[i], ref transform, out destination[i]);
            }
        }
